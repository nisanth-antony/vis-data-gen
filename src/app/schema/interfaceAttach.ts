 ...
 */
 export interface InterfaceAttach {
  ...
  /**
   * A 3 dot object reference to a nodes_node in the parent component at which this component attaches. Matches ˆiso\\.nodes\\.[az_]+$.
   */
